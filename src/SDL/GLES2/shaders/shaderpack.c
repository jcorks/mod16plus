...
int main(int argc, char ** argv) {
    ...
    char * NAMES_IN[] = {
        "ses_sdl__renderer_es2__sprite_vtx.glsl",    
        "ses_sdl__renderer_es2__sprite_frag.glsl",    
        "ses_sdl__renderer_es2__screen_vtx.glsl",    
        "ses_sdl__renderer_es2__screen_frag.glsl",    
